...
object ClusterOperation {
  def apply(operation: String
    ...
    ClusterOperation(operation, ClusterConfig(name, version, bootstrapServers, jmxEnabled, jmxUser, jmxPass, jmxSsl,
  ...
  def customUnapply(co: ClusterOperation) : Option[(String, String, String, String, Boolean, Option[String], Option[String], Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Option[ClusterTuning], String, Option[String], Option[String])] = {
    Option((co.op.toString, co.clusterConfig.name, co.clusterConfig.version.toString,
            co.clusterConfig.bootstrapServers,
